...
| 3 失衡救场 | 石头与救回 | 760 | 26s | 4 | 2.5s |
| 4 金石取舍 | 风险与收益 | 1250 | 29s | 4 | 2s |
| 5 黄金扛工 | 完整挑战 | 1850 | 34s | 3 | 1.6s |
...
- 验证后 3 关收紧后是否仍有平滑的难度递增。
- 验证五种货物的价值、重量和概率是否合理。
- 替换正式音效素材。
- 验证教学提示是否足够清楚。
- 验证关卡间难度是否平滑递增。
- 后续再考虑关卡选择界面。
- 后续可成对加入负价值货物与有成本的丢弃操作。
- 需要调参时再加入 debug 数值开关。
